...
const PrimaryButton = tw(PrimaryButtonBase)`shadow-xl mt-8 md:mt-10 text-sm inline-block mx-auto md:mx-0`;
...
export default ({
  ...
  description = "Farmers, Vendors and Retailers can add their products with full control. \
